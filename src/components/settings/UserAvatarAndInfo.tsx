...
export function AvatarUploadInput({ imgSrc, onChange, hasUploaded }: {
  ...
  return (
      ...
      <Center border={`${hasUploaded === true ? "3px solid" : ""}`} w="50px" h="50px" borderRadius="50%" boxShadow="0px 0px 6px #0000006e" as="label" htmlFor="avatar" position="absolute" top="50%" left="50%" transform="translate(-50%, -50%)">
          <CameraIcon />
        </Center>
      </Box>
  )
